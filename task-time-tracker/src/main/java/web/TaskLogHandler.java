...
public class TaskLogHandler extends AbstractHandler {
	...
	public String find(
		...
		Result<TaskLog> ar = taskLogService.find(taskLogId, sessionUser.getUsername());
	...
	public String store (
		...
		Result<TaskLog> ar = taskLogService.store(
				getIntegerValue(jsonObj.get("taskLogId")), 
				getIntegerValue(jsonObj.get("taskId")), 
				jsonObj.getString("username"),
				jsonObj.getString("taskDescription"),
				DATE_FORMAT_yyyyMMdd.parse(jsonObj.getString("taskLogDate")),
				getIntegerValue(jsonObj.get("taskMinutes")), 
